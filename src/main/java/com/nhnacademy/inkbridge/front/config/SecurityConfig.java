...
public class SecurityConfig {
     ...
     * @return 로그인 필터.
     */
    public CustomLoginAuthenticationFilter customLoginAuthenticationFilter(AuthenticationManager authenticationManager) {
        CustomLoginAuthenticationFilter customLoginAuthenticationFilter = new CustomLoginAuthenticationFilter(memberAdaptor);
