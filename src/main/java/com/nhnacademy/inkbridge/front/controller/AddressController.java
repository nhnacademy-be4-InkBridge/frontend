...
public class AddressController {
    ...
    /**
     * 사용자의 주소 목록을 조회하여 모델에 추가합니다. 조회된 주소 목록은 주소 목록 페이지에 표시됩니다.
     *
    ...
    public String createAddress(
        @Valid @ModelAttribute AddressCreateRequestDto addressCreateRequestDto,
    ...
    public String tagExceptionHandler(ValidationException e,
