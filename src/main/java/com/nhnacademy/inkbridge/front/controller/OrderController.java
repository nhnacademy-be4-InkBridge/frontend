...
public class OrderController {
    ...
    public String orderView(Model model,
        @CookieValue(value = "info", required = false) List<OrderBookReadResponseDto> responseDto) {
        // 도서 정보
        ...
        model.addAttribute("orderBooks",
            List.of(
                ...
                new OrderBookReadResponseDto(2L, "명탐견 오드리, 예감은 꼬리에서부터", true, 12000L, 10800L, 1),
